var redis = require('redis'), client = redis.createClient(), databaseUrl = 'fantasyslackr', collections = [
    'users',
    'players',
    'teams',
    'metadata',
    ...
    'activity',
    'queue'
  ], db = require('mongojs').connect(databaseUrl, collections), utils = require('util'), async = require('async'), appErr = require('../util/applicationErrors'), Player = require('../objects/player');
