var redis = require('redis'),
	...
	collections = ["activity", "queue"],
	db = require("mongojs").connect(databaseUrl, collections),
	objectId = require('mongodb').ObjectID,
	utils = require('util'),
	async = require('async'),
	YahooRequest = require('./yahooRequest').YahooRequest;
...
Job.prototype.send = function(next) {
	...
	async.series([
		function(cb){
			yahooRequest = new YahooRequest(self);
			cb()
		},
		function(cb){
...
Job.prototype.newMethd = function(next){
    return 46;
}

var testCase = new Job(null)
