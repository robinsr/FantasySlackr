var databaseUrl = "fantasyslackr",
	...
	Ranking = require('./ranking').Ranking;
...
Player.prototype.getOwnership = function(next) {
	var self = this
...
Player.prototype.checkoutTeam = function(benchOnly,next) {
	var self = this;
...
Player.prototype.calcValueToTeam = function(next) {
	var self = this;
